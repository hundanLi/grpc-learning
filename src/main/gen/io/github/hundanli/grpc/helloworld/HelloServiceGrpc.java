...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.github.hundanli.grpc.helloworld.HelloRequest,
      io.github.hundanli.grpc.helloworld.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = io.github.hundanli.grpc.helloworld.HelloRequest.class,
      responseType = io.github.hundanli.grpc.helloworld.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.github.hundanli.grpc.helloworld.HelloRequest,
      io.github.hundanli.grpc.helloworld.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<io.github.hundanli.grpc.helloworld.HelloRequest, io.github.hundanli.grpc.helloworld.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<io.github.hundanli.grpc.helloworld.HelloRequest, io.github.hundanli.grpc.helloworld.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.hundanli.grpc.helloworld.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.github.hundanli.grpc.helloworld.HelloReply.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(io.github.hundanli.grpc.helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<io.github.hundanli.grpc.helloworld.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.github.hundanli.grpc.helloworld.HelloRequest,
                io.github.hundanli.grpc.helloworld.HelloReply>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public io.github.hundanli.grpc.helloworld.HelloReply sayHello(io.github.hundanli.grpc.helloworld.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.github.hundanli.grpc.helloworld.HelloReply> sayHello(
        io.github.hundanli.grpc.helloworld.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((io.github.hundanli.grpc.helloworld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<io.github.hundanli.grpc.helloworld.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.github.hundanli.grpc.helloworld.HelloWorldProto.getDescriptor();
    }
